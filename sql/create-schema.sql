...
GO
ALTER TABLE [dbo].[TP_ARTICULO] ADD  CONSTRAINT [DF_TP_ARTICULO_Usuario]  DEFAULT ([dbo].[usuario_real]()) FOR [Usuario]
GO
...
GO
ALTER TABLE [dbo].[TP_ARTICULO_CAJA] ADD  CONSTRAINT [DF_TP_ARTICULO_CAJA_Usuario]  DEFAULT ([dbo].[usuario_real]()) FOR [Usuario]
GO
...
GO
ALTER TABLE [dbo].[TP_FAMILIA] ADD  CONSTRAINT [DF_TP_FAMILIA_Usuario]  DEFAULT ([dbo].[usuario_real]()) FOR [Usuario]
GO
...
GO
ALTER TABLE [dbo].[TP_PRECIOS] ADD  CONSTRAINT [DF_TP_PRECIOS_Usuario]  DEFAULT ([dbo].[usuario_real]()) FOR [Usuario]
GO
...
GO
ALTER TABLE [dbo].[TP_PRECIOS]  WITH CHECK ADD  CONSTRAINT [FK_TP_PRECIOS_TP_TIPOTARIFA] FOREIGN KEY([Tipotarifa])
REFERENCES [dbo].[TP_TIPOTARIFA] ([Tipotarifa])
GO
ALTER TABLE [dbo].[TP_PRECIOS] CHECK CONSTRAINT [FK_TP_PRECIOS_TP_TIPOTARIFA]
GO
